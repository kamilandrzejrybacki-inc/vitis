...
Expose Vitis as an operator-friendly CLI that is explicit about risk, state, and failure modes.
...
- a user can run Vitis without reading source code to understand failure modes
