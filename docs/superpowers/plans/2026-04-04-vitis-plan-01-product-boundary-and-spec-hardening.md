...
This plan does not write Go code. It updates the Vitis design documents so that later implementation work has stable contracts.

---

## Key Decisions To Lock

1. Vitis MVP is local-only and one-user-first.
2. Vitis does not treat Claude consumer subscriptions as safe for hosted/shared brokering.
