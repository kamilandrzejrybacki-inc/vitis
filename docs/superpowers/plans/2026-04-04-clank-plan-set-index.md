# Clank Plan Set Index

- **Status**: Draft
- **Date**: 2026-04-04
- **Scope**: executable plan set for implementing Clank in the local repo
- **Primary inputs**:
  - `../specs/2026-04-03-clank-agent-bridge-design.md`
  - `../specs/2026-04-03-clank-implementation-plan.md`
  - `../specs/2026-04-03-clank-pty-design-review.md`

---

## Purpose

This directory breaks the Clank implementation into a set of workstreams that can be executed in order or partially in parallel.
...
1. `2026-04-04-clank-plan-01-product-boundary-and-spec-hardening.md`
2. `2026-04-04-clank-plan-02-pty-runtime-and-transcript-foundation.md`
3. `2026-04-04-clank-plan-03-claude-code-state-detection-and-extraction.md`
4. `2026-04-04-clank-plan-04-orchestrator-session-and-persistence.md`
5. `2026-04-04-clank-plan-05-cli-and-operator-experience.md`
6. `2026-04-04-clank-plan-06-test-fixtures-and-acceptance.md`
...
- Clank is only useful if it handles real Claude Code PTY behavior, not just mocks
...
- Clank can run a real Claude Code session locally through PTY
- Clank distinguishes completion from blocked/auth/rate-limit states
