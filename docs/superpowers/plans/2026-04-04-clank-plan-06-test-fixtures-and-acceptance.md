...
Prove that Clank works against real PTY behavior rather than a simplified toy model.
...
- Clank behavior is validated against real Claude Code transcript examples
